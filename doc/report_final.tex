...
%TODO 
% Block diagram of arduino (mockup)
% Other flowcharts, diagrams?
...
\par\noindent
%TODO change main diagram (distanceRight instead of distance_right)
...
%TODO collision distance confusing - doesn't go anywhere in diagram when continue analysis happens.  
...
%TODO talk about look functions?
